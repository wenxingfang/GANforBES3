...
if __name__ == '__main__':
    ...
    #filePath = '/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_ForTraining_all.root'
    #filePath = '/junofs/users/wxfang/FastSim/bes3/workarea/SingleParticle/SingleParticle-00-00-01/single_em_ForTrain.root'
    #filePath = '/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_ForTrainAll.root'
    filePath = '/junofs/users/wxfang/FastSim/bes3/workarea/SingleParticle/SingleParticle-00-00-01/single_em_ForTrain.root'
    ...
    for entryNum in range(0, tree.GetEntries()):
        ...
        ext_Px           = getattr(tree,str_ext_Px          )
        ext_Py           = getattr(tree,str_ext_Py          )
        ext_Pz           = getattr(tree,str_ext_Pz          )
        tmp_Hit_E        = getattr(tree,str_emc_hit_energy  )
        MC_info[entryNum][0] = math.sqrt(ext_Px*ext_Px + ext_Py*ext_Py + ext_Pz*ext_Pz)
        #MC_info[entryNum][0] = mdc_mom - etof if (mdc_mom - etof) > 0 else 0
