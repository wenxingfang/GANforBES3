...
def get_parser():
    ...
    parser.add_argument('--using-Low-z'  , action='store', type=ast.literal_eval, default=True ,  help='')
    parser.add_argument('--using-High-z' , action='store', type=ast.literal_eval, default=True ,  help='')
    return parser
...
if __name__ == '__main__':
    ...
    using_Low_z  = parse_args.using_Low_z
    using_High_z = parse_args.using_High_z
    print ('Start..')
    print ('for_test=',for_test,',for_em=',for_em,',using_Z_cut=',using_Z_cut,',using_Low_z=',using_Low_z,',using_High_z=',using_High_z)
    ...
    if using_Low_z == True:
        str_z_region = '_Low'
    if using_High_z == True:
        str_z_region = '_High'
    print ('Read root file')
    plot_path='./raw_plots'
    filePath = '/junofs/users/wxfang/FastSim/bes3/workarea/SingleParticle/SingleParticle-00-00-01/single_e.root'
    ...
    if for_test:
        ...
        filePath = '/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_220_noMix_rereco_tf.root'
    ...
    for entryNum in range(0, tree.GetEntries()):
        ...
        if for_em and using_Low_z:
            ...
            if ext_Z<125 : continue
        #elif for_em==False and reset_z:
        #    if ext_Z<120 and ext_Z>0: ext_Z = 0
