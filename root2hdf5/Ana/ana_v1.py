...
def do_plot_h2(h_real, h_fake, out_name, title):
    ...
    if "cell_energy" in out_name:
        ...
        x_min=0.4
        x_max=0.6
    elif ("e3x3" in out_name or 'e5x5' in out_name or 'shower_e' in out_name or 'cluster_e' in out_name ) and 'diff' not in out_name:
        x_min=1
        x_max=2
...
def do_plot_H2(h, out_name, title):
    canvas=rt.TCanvas("%s"%(out_name),"",800,800)
    canvas.cd()
    canvas.SetTopMargin(0.13)
    canvas.SetBottomMargin(0.12)
    canvas.SetLeftMargin(0.13)
    canvas.SetRightMargin(0.15)
    h.GetYaxis().SetTitle(title['Y'])
    h.GetXaxis().SetTitle(title['X'])
...
class Obj:
    def __init__(self, name, fileName):
        ...
        self.h_ep_etof                = rt.TH1F('%s_ep_etof'%(str_ext),'',40,0,0.4)
        self.h_ep_e3x3                = rt.TH1F('%s_ep_e3x3'%(str_ext),'',200,0,2)
        self.h_ep_e5x5                = rt.TH1F('%s_ep_e5x5'%(str_ext),'',200,0,2)
        self.h_ep_e5x5_etof           = rt.TH1F('%s_ep_e5x5_etof'%(str_ext),'',200,0,2)
        self.h_ep_e5x5_etof_diff      = rt.TH1F('%s_ep_e5x5_etof_diff'%(str_ext),'',100,1,2)
        self.h_ep_mom_e5x5_diff       = rt.TH1F('%s_ep_mom_e5x5_diff'%(str_ext),'',100,-0.5,0.5)
        ...
        self.h_em_etof                = rt.TH1F('%s_em_etof'%(str_ext),'',40,0,0.4)
        self.h_em_e3x3                = rt.TH1F('%s_em_e3x3'%(str_ext),'',200,0,2)
        self.h_em_e5x5                = rt.TH1F('%s_em_e5x5'%(str_ext),'',200,0,2)
        self.h_em_mom_e5x5_diff       = rt.TH1F('%s_em_mom_e5x5_diff'%(str_ext),'',100,-0.5,0.5)
        self.h_em_e5x5_etof           = rt.TH1F('%s_em_e5x5_etof'%(str_ext),'',200,0,2)
        self.h_em_e5x5_etof_diff      = rt.TH1F('%s_em_e5x5_etof_diff'%(str_ext),'',100,1,2)
        ...
        self.h_em_e5x5_id                = rt.TH2F('%s_em_e5x5_id'%(str_ext)   ,'',100,1,2, 40, 0, 40)
        self.h_ep_e5x5_id                = rt.TH2F('%s_ep_e5x5_id'%(str_ext)   ,'',100,1,2, 40, 0, 40)
        self.h_em_e5x5_tof               = rt.TH2F('%s_em_e5x5_tof'%(str_ext)   ,'',100,1,2, 40, 0, 0.2)
        self.h_ep_e5x5_tof               = rt.TH2F('%s_ep_e5x5_tof'%(str_ext)   ,'',100,1,2, 40, 0, 0.2)


        self.h_ef                     = rt.TH1F('%s_ef'%(str_ext)   ,'',100,1,2)
        self.h_e5                     = rt.TH1F('%s_e5'%(str_ext)   ,'',100,1,2)
        self.h_ec                     = rt.TH1F('%s_ec'%(str_ext)   ,'',100,1,2)
        self.h_ct                     = rt.TH1F('%s_ct'%(str_ext)   ,'',100,0.9,1.1)
        self.h_cedge                  = rt.TH1F('%s_cedge'%(str_ext),'',100,0.9,1.1)
        self.h_em_ef                     = rt.TH1F('%s_em_ef'%(str_ext)   ,'',100,1,2)
        self.h_em_e5                     = rt.TH1F('%s_em_e5'%(str_ext)   ,'',100,1,2)
        self.h_em_ec                     = rt.TH1F('%s_em_ec'%(str_ext)   ,'',100,1,2)
        self.h_em_ct                     = rt.TH1F('%s_em_ct'%(str_ext)   ,'',100,0.9,1.1)
        self.h_em_cedge                  = rt.TH1F('%s_em_cedge'%(str_ext),'',100,0.9,1.1)
        self.h_ep_ef                     = rt.TH1F('%s_ep_ef'%(str_ext)   ,'',100,1,2)
        self.h_ep_e5                     = rt.TH1F('%s_ep_e5'%(str_ext)   ,'',100,1,2)
        self.h_ep_ec                     = rt.TH1F('%s_ep_ec'%(str_ext)   ,'',100,1,2)
        self.h_ep_ct                     = rt.TH1F('%s_ep_ct'%(str_ext)   ,'',100,0.9,1.1)
        self.h_ep_cedge                  = rt.TH1F('%s_ep_cedge'%(str_ext),'',100,0.9,1.1)
    ...
    def fill(self):
        ...
        for entryNum in range(0, tree.GetEntries()):
            ...
            m_ep_etof                = getattr(tree, 'ep_etof')
            ...
            m_em_etof                = getattr(tree, 'em_etof')
            ...
            m_ep_thetaModule         = getattr(tree, 'ep_thetaModule')
            ...
            m_em_thetaModule         = getattr(tree, 'em_thetaModule')
            ...
            self.h_ep_e5x5_id             .Fill(m_ep_e5x5, m_ep_thetaModule)
            self.h_em_e5x5_id             .Fill(m_em_e5x5, m_em_thetaModule)
            self.h_ep_e5x5_tof            .Fill(m_ep_e5x5, m_ep_etof)
            self.h_em_e5x5_tof            .Fill(m_em_e5x5, m_em_etof)
            ...
            self.h_ep_etof                .Fill(m_ep_etof                )
            self.h_ep_e3x3                .Fill(m_ep_e3x3                )
            self.h_ep_e5x5                .Fill(m_ep_e5x5                )
            self.h_ep_mom_e5x5_diff       .Fill(m_ep_mdc_mom -m_ep_e5x5  )
            self.h_ep_e5x5_etof           .Fill(m_ep_e5x5 + m_ep_etof    )
            self.h_ep_e5x5_etof_diff      .Fill(m_ep_e5x5 - m_ep_etof    )
            ...
            self.h_em_etof                .Fill(m_em_etof                )
            self.h_em_e3x3                .Fill(m_em_e3x3                )
            self.h_em_e5x5                .Fill(m_em_e5x5                )
            self.h_em_mom_e5x5_diff       .Fill(m_em_mdc_mom -m_em_e5x5  )
            self.h_em_e5x5_etof           .Fill(m_em_e5x5 + m_em_etof    )
            self.h_em_e5x5_etof_diff      .Fill(m_em_e5x5 - m_em_etof    )
    ...
    def fill_c(self):
        ...
        for entryNum in range(0, tree.GetEntries()):
            ...
            m_em_ef             = getattr(tree, 'em_ef')
            m_em_e5             = getattr(tree, 'em_e5')
            m_em_ec             = getattr(tree, 'em_ec')
            m_em_ct             = getattr(tree, 'em_ct')
            m_em_cedge          = getattr(tree, 'em_cedge')
            m_ep_ef             = getattr(tree, 'ep_ef')
            m_ep_e5             = getattr(tree, 'ep_e5')
            m_ep_ec             = getattr(tree, 'ep_ec')
            m_ep_ct             = getattr(tree, 'ep_ct')
            m_ep_cedge          = getattr(tree, 'ep_cedge')

            self.h_em_ef       .Fill(m_em_ef )
            self.h_em_e5       .Fill(m_em_e5 )
            self.h_em_ec       .Fill(m_em_ec )
            self.h_em_ct       .Fill(m_em_ct )
            self.h_em_cedge    .Fill(m_em_cedge )
            self.h_ep_ef       .Fill(m_ep_ef )
            self.h_ep_e5       .Fill(m_ep_e5 )
            self.h_ep_ec       .Fill(m_ep_ec )
            self.h_ep_ct       .Fill(m_ep_ct )
            self.h_ep_cedge    .Fill(m_ep_cedge )
...
obj_orgin        = Obj('orgin','/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_noMix.root')
#obj_orgin        = Obj('orgin','/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_ForTest.root')
#obj_orgin        = Obj('orgin','/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_0to9_NshowerCheck_useTof.root')
#obj_orgin        = Obj('orgin','/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_0to9_NshowerCheckv4.root')
#obj_orgin        = Obj('orgin','/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_0to9_NshowerCheckv3.root')
#obj_orgin        = Obj('orgin','/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_0to9_NshowerCheckv2.root')
#obj_orgin        = Obj('orgin','/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_baba_0to9_NshowerCheckv1.root')
...
obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_noMix_tf_20191125_newExtTrk_ep189.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191121_newExtTrk_ep189.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191121_newExtTrk_ep170.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191121_newExtTrk_ep69.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191116_minusTof_ep179.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191116_minusTof_ep182.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191116_minusTof_ep181.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191116_minusTof.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_old_0to9_noMix_tf_20191114_useTof.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_old_0to9_noMix_tf_20191114.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191113_epoch59v4.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191113_epoch59v3.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191113_epoch59v2.root')
#obj_fake         = Obj('fake' ,'/junofs/users/wxfang/FastSim/bes3/workarea/Luminosity/mc_0to9_noMix_tf_20191113_epoch59v1.root')
...
do_plot_h2(obj_orgin.h_ep_etof               ,obj_fake.h_ep_etof               , "ep_etof"              ,{'X':"e_{tof}^{e^{+}} (GeV)"             ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_ep_e5x5_etof          ,obj_fake.h_ep_e5x5_etof          , "ep_e5x5_etof"         ,{'X':"e_{5x5+tof}^{e^{+}} (GeV)"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_e5x5_etof_diff     ,obj_fake.h_ep_e5x5_etof_diff     , "ep_e5x5_etof_diff"    ,{'X':"e_{5x5-tof}^{e^{+}} (GeV)"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_mom_e5x5_diff      ,obj_fake.h_ep_mom_e5x5_diff      , "ep_mom_e5x5_diff"     ,{'X':"P_{mdc}-e_{5x5}^{e^{+}} (GeV)"             ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_ep_cluster2ndMoment   ,obj_fake.h_ep_cluster2ndMoment   , "ep_cluster2ndMoment"  ,{'X':"2ndMom_{cluster}^{e^{+}} (cm^{2})"        ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_ep_secondMoment       ,obj_fake.h_ep_secondMoment       , "ep_secondMoment"      ,{'X':"2ndMom_{shower}^{e^{+}} (cm^{2})"         ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_latMoment          ,obj_fake.h_ep_latMoment          , "ep_latMoment"         ,{'X':"latMom_{shower}^{e^{+}}"   ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_a20Moment          ,obj_fake.h_ep_a20Moment          , "ep_a20Moment"         ,{'X':"a20Mom_{shower}^{e^{+}}"   ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_a42Moment          ,obj_fake.h_ep_a42Moment          , "ep_a42Moment"         ,{'X':"a42Mom_{shower}^{e^{+}}"   ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_em_etof               ,obj_fake.h_em_etof               , "em_etof"              ,{'X':"e_{tof}^{e^{-}} (GeV)"             ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_em_mom_e5x5_diff      ,obj_fake.h_em_mom_e5x5_diff      , "em_mom_e5x5_diff"     ,{'X':"P_{mdc}-e{5x5}^{e^{-}} (GeV)"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_e5x5_etof          ,obj_fake.h_em_e5x5_etof          , "em_e5x5_etof"         ,{'X':"e_{5x5+tof}^{e^{-}} (GeV)"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_e5x5_etof_diff     ,obj_fake.h_em_e5x5_etof_diff     , "em_e5x5_etof_diff"    ,{'X':"e_{5x5-tof}^{e^{-}} (GeV)"             ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_em_cluster2ndMoment   ,obj_fake.h_em_cluster2ndMoment   , "em_cluster2ndMoment"  ,{'X':"2ndMom_{cluster}^{e^{-}} (cm^{2})"        ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_em_secondMoment       ,obj_fake.h_em_secondMoment       , "em_secondMoment"      ,{'X':"2ndMom_{shower}^{e^{-}} (cm^{2})"         ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_latMoment          ,obj_fake.h_em_latMoment          , "em_latMoment"         ,{'X':"latMom_{shower}^{e^{-}}"   ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_a20Moment          ,obj_fake.h_em_a20Moment          , "em_a20Moment"         ,{'X':"a20Mom_{shower}^{e^{-}}"   ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_a42Moment          ,obj_fake.h_em_a42Moment          , "em_a42Moment"         ,{'X':"a42Mom_{shower}^{e^{-}}"   ,'Y':'Events'} )
...
do_plot_h2(obj_orgin.h_em_ef        ,obj_fake.h_em_ef        , "em_ef"           ,{'X':"ef"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_e5        ,obj_fake.h_em_e5        , "em_e5"           ,{'X':"e5"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_ec        ,obj_fake.h_em_ec        , "em_ec"           ,{'X':"ec"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_ct        ,obj_fake.h_em_ct        , "em_ct"           ,{'X':"ct"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_em_cedge     ,obj_fake.h_em_cedge     , "em_cedge"        ,{'X':"cedge"          ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_ef        ,obj_fake.h_ep_ef        , "ep_ef"           ,{'X':"ef"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_e5        ,obj_fake.h_ep_e5        , "ep_e5"           ,{'X':"e5"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_ec        ,obj_fake.h_ep_ec        , "ep_ec"           ,{'X':"ec"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_ct        ,obj_fake.h_ep_ct        , "ep_ct"           ,{'X':"ct"             ,'Y':'Events'} )
do_plot_h2(obj_orgin.h_ep_cedge     ,obj_fake.h_ep_cedge     , "ep_cedge"        ,{'X':"cedge"          ,'Y':'Events'} )

do_plot_H2(obj_orgin.h_ep_e5x5_id  , "real_ep_e5x5_id"        ,{'X':"e5x5 (GeV)"          ,'Y':'id'} )
do_plot_H2(obj_fake .h_ep_e5x5_id  , "fake_ep_e5x5_id"        ,{'X':"e5x5 (GeV)"          ,'Y':'id'} )
do_plot_H2(obj_orgin.h_em_e5x5_id  , "real_em_e5x5_id"        ,{'X':"e5x5 (GeV)"          ,'Y':'id'} )
do_plot_H2(obj_fake .h_em_e5x5_id  , "fake_em_e5x5_id"        ,{'X':"e5x5 (GeV)"          ,'Y':'id'} )

do_plot_H2(obj_orgin.h_ep_e5x5_tof  , "real_ep_e5x5_tof"        ,{'X':"e5x5 (GeV)"          ,'Y':'etof (GeV)'} )
do_plot_H2(obj_fake .h_ep_e5x5_tof  , "fake_ep_e5x5_tof"        ,{'X':"e5x5 (GeV)"          ,'Y':'etof (GeV)'} )
do_plot_H2(obj_orgin.h_em_e5x5_tof  , "real_em_e5x5_tof"        ,{'X':"e5x5 (GeV)"          ,'Y':'etof (GeV)'} )
do_plot_H2(obj_fake .h_em_e5x5_tof  , "fake_em_e5x5_tof"        ,{'X':"e5x5 (GeV)"          ,'Y':'etof (GeV)'} )
