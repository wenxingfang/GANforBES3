...
#try to make the training more converge for em Low, em High, ep Low, ep High
##########################################################################
...
if __name__ == '__main__':
    ...
    from architectures import build_generator_2D, build_discriminator_2D, build_generator_2D_v1, build_generator_2D_v2, build_discriminator_2D_v1
