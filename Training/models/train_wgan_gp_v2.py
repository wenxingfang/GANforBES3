...
if __name__ == '__main__':
    ...
    from architectures import build_generator_2D, build_discriminator_2D, build_generator_2D_v1, build_generator_2D_v2, build_generator_2D_v2_2, build_discriminator_2D_v2, RandomWeightedAverage, RandomWeightedAverage1, wasserstein_loss, gradient_penalty_loss 
    ...
    GRADIENT_PENALTY_WEIGHT = 0.8 #1 #2 #5 #10
