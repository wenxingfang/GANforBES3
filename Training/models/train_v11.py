...
if __name__ == '__main__':
    ...
    from ops import (minibatch_discriminator, minibatch_output_shape, Dense3D,
                     calculate_energy, scale, inpainting_attention, sparsity_level, get_mc_info, single_layer_relative_diff_too_big, calculate_e3x3, calculate_e5x5, single_layer_energy, single_layer_relative, mini_batch_mean, mini_batch_std )
    ...
    Z_info   = Lambda(lambda x:x[:,5:6], name='z_layer')  (input_Info)
...
#    print('en_diff:', en_diff.shape)
    ratio_en = Lambda(single_layer_relative)([energies,mom_info])
    print('ratio_en:', ratio_en.shape)
    ratio_e3x3 = Lambda(single_layer_relative)([energies_3x3,mom_info])
    print('ratio_e3x3:', ratio_e3x3.shape)
    ratio_e5x5 = Lambda(single_layer_relative)([energies_5x5,mom_info])
...
#    print('ref_diff_std:',ref_diff_std.shape)
    ...
    en_info  = concatenate([energies, mom_info, ratio_e3x3, ratio_e5x5, ratio_en, too_big, Z_info])
    #p_e_1 = Dense(8, name='energy_features1')(en_info)
    #p_e_2 = Dense(8, activation='relu', name='energy_features2')(p_e_1)
    #p_e_3 = Dense(1, name='energy_features3')(p_e_2)
    p  = concatenate([p1, en_info])
