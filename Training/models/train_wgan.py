...
if __name__ == '__main__':
    ...
    from architectures import build_generator_2D, build_discriminator_2D, build_generator_2D_v1, build_generator_2D_v2, build_generator_2D_v2_1, build_generator_2D_v2_2, build_generator_2D_v3, build_discriminator_2D_v1,wasserstein_loss
...
#        n_mc_info = 5
    ...
    generator.compile(
        ...
        loss='binary_crossentropy'##not important here, use combined_losses finally
    )
    print('h3')
######### regression part ##########################
...
###################################
    ...
    if parse_args.LoadTrainedWeight:
    ...
    for epoch in range(nb_epochs):
        ...
        disc_outputs_fake =  np.ones(batch_size)
        ...
        for index in range(nb_batches):
            ...
            while True:
                ...
                combined_outputs = [disc_outputs_real, info_batch_v2[:,0:3] ]
        ...
        tmp_tot_loss  = np.mean(epoch_disc_loss, axis=0)
        f_out.write('%d %f\n'%(epoch, tmp_tot_loss))    
