...
from architectures import binary_loss 
...
if __name__ == '__main__':
    ...
    if parse_args.comb_model_in !='':
        comb_model = load_model(parse_args.comb_model_in, custom_objects={'tf': tf,'MyDense2D':MyDense2D(output_dim1=10, output_dim2=10), 'single_layer_energy':single_layer_energy,'binary_loss':binary_loss })
